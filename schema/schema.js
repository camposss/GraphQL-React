...
// Work around by using a closure. fields: User Type gets defined in the closure scope, it will run after the file runs
...
// constructs user graph ql what type of user
...
// Mutations used to make changes to the data
